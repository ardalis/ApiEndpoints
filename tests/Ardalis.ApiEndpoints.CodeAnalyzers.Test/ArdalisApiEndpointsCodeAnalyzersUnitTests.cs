...
namespace MakeConstTest
{
    class Program
    {
            ...
            int column)
        {
            ...
            {
                Id = ArdalisApiEndpointsCodeAnalyzersAnalyzer.DiagnosticId,
        ...
        {
            return new ArdalisApiEndpointsCodeAnalyzersCodeFixProvider();
        }

        protected override DiagnosticAnalyzer GetCSharpDiagnosticAnalyzer()
        {
            return new ArdalisApiEndpointsCodeAnalyzersAnalyzer();
        }
    }
}