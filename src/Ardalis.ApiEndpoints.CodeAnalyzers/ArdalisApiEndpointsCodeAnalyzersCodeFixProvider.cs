...
{
    [ExportCodeFixProvider(LanguageNames.CSharp, Name = nameof(ArdalisApiEndpointsCodeAnalyzersCodeFixProvider)), Shared]
    public class ArdalisApiEndpointsCodeAnalyzersCodeFixProvider : CodeFixProvider
    {
        // <SnippetCodeFixTitle>
        ...
        {
            get { return ImmutableArray.Create(ArdalisApiEndpointsCodeAnalyzersAnalyzer.DiagnosticId); }
        }
